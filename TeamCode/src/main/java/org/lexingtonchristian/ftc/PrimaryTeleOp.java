 ...
 * {@code backLeft}  - {@code Port 0}, {@code Control Hub}
 * {@code backRight} - {@code Port 0}, {@code Control Hub}
 * {@code backRight} - {@code Port 0}, {@code Control Hub}
 *
 */
...
public class PrimaryTeleOp extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (this.opModeIsActive()) {
            ...
            this.backLeft.setPower(left(lX + lY, rX) * mult);
            this.frontLeft.setPower(left(lX - lY, rX) * mult);

            this.backRight.setPower(right(lX + lY, rX) * mult);
            this.frontRight.setPower(right(lX - lY, rX) * mult);
            ...
            if (this.gamepad1.b) this.launcherServo.setPower(0.7);
    ...
    private void hardwareInit() {
        ...
        this.portal = new VisionPortal.Builder()
                ...
                .setCameraResolution(new Size(680, 420))
                .build();
